...
In order to obtain data related to General Ledger, the [access token](../getting_started/obtaining_request_token.md) must be generated by including **audit** in the scope.
